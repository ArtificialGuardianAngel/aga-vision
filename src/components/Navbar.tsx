...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-[20px] left-[50%] translate-x-[-50%] p-[0_10px] bg-white/10 z-[100] flex rounded-[50px] text-[13px] font-[600] whitespace-nowrap uppercase text-white leading-[7px] items-center transition-colors md:hidden backdrop-blur-[25px]">
