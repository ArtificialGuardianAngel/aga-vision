      ...
      <section className="p-[150px_0_25px]">
        ...
        <div className="container">
          <div className="flex flex-col gap-[50px] items-center">
            ...
            <div className="p-[30px_50px] rounded-[100px] bg-[rgba(255,255,255,0.05)] text-[40px] font-[200] leading-[calc(29/40)]">
              {data.title}
            </div>

            <div className="linear-rect"></div>

            <div className="bg-card p-[70px_50px] rounded-[20px] w-full">
