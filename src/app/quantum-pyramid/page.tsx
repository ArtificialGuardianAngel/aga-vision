...
export default function QuantumPyramid() {
  return (
    <main className="relative">
      ...
      <section className="p-[100px_0_25px]">
        <VideoBackground />
        ...
        <div className="container flex flex-col gap-[100px]">
          ...
          <div className="bg-card p-[70px_50px] flex flex-col gap-[50px] text-center text-[18px] rounded-[20px]">
            <div>
          ...
          <div className="flex flex-col gap-[50px] items-center">
            ...
            <h4 className="text-[30px] font-[300]">Pre-order details</h4>
